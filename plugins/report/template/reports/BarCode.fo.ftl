  ...
  <fo:page-sequence master-reference="main">
    <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
      ...
      <fo:block text-align="center">
        ...
        <fo:external-graphic
            src="/report/control/qrcode;jsessionid=${session.id}?message=${report.reportName?url}&amp;format=bmp&amp;encoding=UTF-8&amp;verifyOutput=true&amp;logoImageMaxWidth=20&amp;logoImageMaxHeight=20"
