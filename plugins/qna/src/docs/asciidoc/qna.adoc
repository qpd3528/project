...
The Qna application will allow you to discover the possibilities to create an application, with a lot of search boxes,
lists and many more.

This application could be used to have an qna of the bests practices in user interface development in Apache - OFBiz.

Look help for each qna screen, help will explain which part of development is used in this case.

For qna, if you want to see how you should do to add some help you can look to help files in src/docs/asciisoc/_include/
directory and src/docs/asciisoc/qna.adoc both in qna component.
...
To have the complete list you should click on index button and look to qna tree option, but here is a list of
main shortcut :
...
include::_include/qna_main.adoc[leveloffset=+2]
